...
http://ldapjs.org/examples.html
	...
	final String ldapUsername = "uid=maryAdmin@marklogic.com,’";
	final String ldapPassword = "marysPassword";

	final String contributor = "Joe User";

    assertEquals(
      "joeUser@marklogic.com",
...
server.listen(options.ldap.port, options.ldap.hostname, function () {
  ...
  ldapsearch -H ldap://localhost:8389 -x -D cn=root -w admin -LLL
    ...
    uid=maryAdmin@marklogic.com,ou=people,dc=samplestack,dc=org))" \
   cn
   */
  ...
  db['uid=joeUser@marklogic.com,ou=people,dc=samplestack,dc=org'] = {
  ...
  db['uid=maryAdmin@marklogic.com,ou=people,dc=samplestack,dc=org'] = {
  ...
  db['cn=contributors,ou=groups,dc=samplestack,dc=org'] = {
    ...
    attributes: {
      ...
      uniqueMember: [
        'uid=maryAdmin@marklogic.com,ou=people,dc=samplestack,dc=org',
        'uid=joeUser@marklogic.com,ou=people,dc=samplestack,dc=org'
      ]
    }
  };
